            ...
            <section class="vbox">
                <section class="scrollable padder">
                    ...
                    <section class="row m-b-md">
                        <div class="col-sm-6">
                            <h3 class="m-b-xs text-black">Change Password</h3> <small>Welcome back, <?php echo  $_SESSION['name']; ?>, <i class="fa fa-map-marker fa-lg text-primary"></i> <?php echo  $_SESSION['email']; ?></small> </div>
                    ...
                    <?php
                        if (isset($_POST['pass'])) {
                          ...
                          if (empty($old_pass) || empty($new_pass) || empty($confirm_pass) ) {
                            ...
                            $mess = "<p class=\"alert alert-danger\">Your password do not mathch ! <button class=\"close\" data-dismiss=\"alert\">&times;</button></p>";
                          }elseif ($old_pass_check == false) {
                            $mess = "<p class=\"alert alert-danger\">Your old password do not mathch ! <button class=\"close\" data-dismiss=\"alert\">&times;</button></p>";
                          } else {
